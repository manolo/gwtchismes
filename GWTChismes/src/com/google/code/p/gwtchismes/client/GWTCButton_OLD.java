 ...
 * 
 */
public class GWTCButton_OLD extends Button implements SourcesMouseEvents {
    ...
    private void setupGWTCButton() {
        addStyleName(GWTCButton_OLD.CBUTTON);
     ...
     */
    public GWTCButton_OLD(String html) {
        super(html);
        setupGWTCButton();
    }
     ...
     */
    public GWTCButton_OLD(String html, ClickListener listener) {
        super(html, listener);
        setupGWTCButton();
    }
    ...
    public static final MouseListener mouseOverListener = new MouseListener() {
        ...
        public void onMouseMove(Widget sender, int x, int y) {
            sender.removeStyleName(GWTCButton_OLD.CACTIVE);
        }

        public void onMouseLeave(Widget sender) {
            sender.removeStyleName(GWTCButton_OLD.CHOVER);
            sender.removeStyleName(GWTCButton_OLD.CACTIVE);
        }

        public void onMouseEnter(Widget sender) {
            sender.addStyleName(GWTCButton_OLD.CHOVER);
        }

        public void onMouseDown(Widget sender, int x, int y) {
            sender.addStyleName(GWTCButton_OLD.CACTIVE);
        }
    };
