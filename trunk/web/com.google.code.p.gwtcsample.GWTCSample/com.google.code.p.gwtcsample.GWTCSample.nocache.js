function com_google_code_p_gwtcsample_GWTCSample(){
  ...
  if (isHostedMode()) {
    ...
    try {
      unflattenKeylistIntoAnswers(['opera'], '8D4D67D05917843A392A27DC025B93FD.cache.html');
      unflattenKeylistIntoAnswers(['ie6'], 'B9D2E22ED06673390CA9843C2BE74812.cache.html');
      unflattenKeylistIntoAnswers(['gecko1_8'], '0FF2BA02DB78036257BA80A5E4C885B7.cache.html');
      unflattenKeylistIntoAnswers(['gecko'], 'D043F9401CD0BC8ACB9B73B5231C9BF1.cache.html');
      unflattenKeylistIntoAnswers(['safari'], '9E68C769073CD783DD974062447B8F5A.cache.html');
