...
function doAttachChildren_0(){
  tryCommand(this, ($clinit_276() , attachCommand));
}

function doDetachChildren_0(){
  tryCommand(this, ($clinit_276() , detachCommand));
}
...
function $PopupPanel_0(this$static, autoHide){
  ...
  this$static.animType = ($clinit_331() , CENTER_0);
...
function $setPopupPosition(this$static, left, top_0){
  ...
  elem.style['left'] = left + ($clinit_138() , 'px');
...
function $setState(this$static, showing, maybeAnimate){
  ...
  if (showing) {
    ...
    this$static.historyHandlerRegistration = ($clinit_259() , $addValueChangeHandler_3(impl_0, $PopupPanel$4(new PopupPanel$4, this$static)));
  }
...
function $initialize_0(this$static, options){
  ...
  $add_1(this$static, this$static.contentTable, ($clinit_287() , NORTH));
}
...
function $DecoratorPanel(this$static, rowStyles, containerIndex){
  ...
  for (i = 0; i < rowStyles.length; ++i) {
    row = (trElem = $doc.createElement('tr') , trElem['className'] = rowStyles[i] , $clinit_222() , trElem.appendChild(createTD(rowStyles[i] + 'Left')) , trElem.appendChild(createTD(rowStyles[i] + 'Center')) , trElem.appendChild(createTD(rowStyles[i] + 'Right')) , trElem);
...
function $GWTCBox(this$static){
  ...
  $add_8(this$static.panel, this$static.title, ($clinit_287() , NORTH));
...
function objectToWidget(object){
  ...
  if (object == null) {
    ...
    $equalsIgnoreCase(($clinit_116() , element).tagName, 'div') || $equalsIgnoreCase(element.tagName, 'span')?(html = (html_0 = $HTML_1(new HTML, element) , $onAttach(html_0) , $clinit_342() , $add_13(widgetsToDetach, html_0) , html_0)):(html = $GWTCBox$2(new GWTCBox$2, element));
  }
  return html;
}
...
function $Label_0(this$static, text){
  $Label(this$static);
  $setInnerText_0(($clinit_116() , this$static.element_0), text);
  return this$static;
}
...
function setText(text){
  $setInnerText_0(($clinit_116() , this.element_0), text);
}
...
function setText_0(text){
  $setInnerText_0(($clinit_116() , this.getElement_0()), text);
}
...
function $addMouseDownHandler(this$static, handler){
  return this$static.container?$addDomHandler(this$static.textPanel, handler, ($clinit_185() , $clinit_185() , TYPE_7)):$addDomHandler(this$static, handler, ($clinit_185() , $clinit_185() , TYPE_7));
}

function $addMouseOutHandler(this$static, handler){
  return this$static.container?$addDomHandler(this$static.textPanel, handler, ($clinit_189() , $clinit_189() , TYPE_9)):$addDomHandler(this$static, handler, ($clinit_189() , $clinit_189() , TYPE_9));
}

function $addMouseOverHandler(this$static, handler){
  return this$static.container?$addDomHandler(this$static.textPanel, handler, ($clinit_191() , $clinit_191() , TYPE_10)):$addDomHandler(this$static, handler, ($clinit_191() , $clinit_191() , TYPE_10));
}
...
function $setText_2(this$static, txt){
  if (!this$static.container) {
    $setInnerText_0(($clinit_116() , this$static.getElement_0()), txt);
  }
   else {
    $clear(this$static.textPanel);
...
function $setType(this$static, type){
  ...
  if (type == 0) {
    ...
    $addDomHandler(this$static.textPanel, this$static.focusHandler, ($clinit_155() , $clinit_155() , TYPE_3));
    $addDomHandler(this$static.textPanel, this$static.blurHandler, ($clinit_148() , $clinit_148() , TYPE_1));
    $addDomHandler(this$static.textPanel, this$static.keyPressHandler, ($clinit_180() , $clinit_180() , TYPE_5));
    $addDomHandler(this$static.textPanel, this$static.mouseDownHandler, ($clinit_185() , $clinit_185() , TYPE_7));
    $addDomHandler(this$static.textPanel, this$static.mouseOverHandler, ($clinit_191() , $clinit_191() , TYPE_10));
    $addDomHandler(this$static.textPanel, this$static.mouseOutHandler, ($clinit_189() , $clinit_189() , TYPE_9));
...
function $clinit_29(){
  ...
  dateTimeConstants_0 = $getDateTimeConstants(($clinit_222() , $clinit_222() , instance_0));
...
function formatDate(format, date){
  ...
  if (!date)
    return format;
  return $format($DateTimeFormat_0(new DateTimeFormat, format, $getDateTimeConstants(($clinit_222() , $clinit_222() , instance_0))), date);
}
...
function parseDate(format, dateStr){
  ...
  var $e0;
  try {
    return $parse($DateTimeFormat_0(new DateTimeFormat, format, $getDateTimeConstants(($clinit_222() , $clinit_222() , instance_0))), dateStr, false);
  }
   catch ($e0) {
    $e0 = caught_0($e0);
    if (instanceOf($e0, 3)) {
...
function $layoutButtons(this$static, distribution){
  ...
  for (i = 0; i < panels.length && i < s.length; ++i) {
    ...
    for (j = 0; j < s[i].length; ++j) {
      !!(w = $getButton(this$static, s[i], j)) && $add_8(p_0, w, p_0 != this$static.rightButtons?($clinit_287() , WEST):($clinit_287() , EAST));
      j == ~~(s[i].length / 2) && (m = w);
    }
    ...
    i < 3?$add_8(this$static.navButtonsTop, p_0, ($clinit_287() , NORTH)):i < 6 && $add_8(this$static.navButtonsBottom, p_0, ($clinit_287() , NORTH));
...
function $refresh(this$static){
  ...
  for (i = 0; i < this$static.simpleDatePickers.arrayList.size; ++i) {
    ...
    $setInnerText_0(($clinit_116() , dynamicCast($get_3(this$static.monthHeaders.arrayList, i), 5).element_0), formatDate('MMMM, yyyy', dynamicCast($get_3(this$static.simpleDatePickers.arrayList, i), 4).getCursorDate()));
  }
}

function $setCaptionText(this$static, t){
  !!this$static.calendarDlg && ($setInnerText_0(($clinit_116() , this$static.calendarDlg.caption.element_0), t) , undefined);
}
...
function $setI18nMessages(this$static, strs){
  ...
  caption != null && (!!this$static.calendarDlg && ($setInnerText_0(($clinit_116() , this$static.calendarDlg.caption.element_0), caption) , undefined) , undefined);
}
...
function $clinit_35(){
  ...
  impl = ($clinit_362() , $clinit_362() , implPanel);
}
...
function $show_4(this$static){
  !this$static.attached && $add_7(($clinit_342() , get_0(null)), this$static, 0, 0);
...
function maximizeWidget(widget){
  ...
  if (!widget)
    return;
  w = max_0($doc.documentElement.clientWidth || $doc.body.clientWidth, max_0(getWindowScrollWidth(), ($clinit_342() , parseInt(get_0(null).element_0['offsetWidth']) || 0)));
...
function $initListeners(this$static){
  ...
  $addDomHandler(this$static.nightsListBox, $GWTCIntervalSelector$7(new GWTCIntervalSelector$7, this$static), ($clinit_150() , $clinit_150() , TYPE_2));
...
function $setMaxdays(this$static, d){
  ...
  $addDomHandler(this$static.nightsListBox, $GWTCIntervalSelector$3(new GWTCIntervalSelector$3, this$static), ($clinit_150() , $clinit_150() , TYPE_2));
...
function $updateInputsFromNights(this$static){
  ...
  $setInnerText_0(($clinit_116() , this$static.checkoutDateValue.element_0), $getSelectedDateStr(this$static.checkoutCalendar, this$static.dateFormat));
...
function $updateTextElements(this$static){
  $setInnerText_0(($clinit_116() , this$static.checkinDateValue.element_0), $getSelectedDateStr(this$static.checkinCalendar, this$static.dateFormat));
...
function $DialogBox_0(this$static, autoHide, modal){
  ...
  $addDomHandler(this$static, mouseHandler, ($clinit_185() , $clinit_185() , TYPE_7));
  $addDomHandler(this$static, mouseHandler, ($clinit_193() , $clinit_193() , TYPE_11));
  $addDomHandler(this$static, mouseHandler, ($clinit_187() , $clinit_187() , TYPE_8));
  $addDomHandler(this$static, mouseHandler, ($clinit_191() , $clinit_191() , TYPE_10));
  $addDomHandler(this$static, mouseHandler, ($clinit_189() , $clinit_189() , TYPE_9));
  return this$static;
}
...
function setText_2(text){
  $setInnerText_0(($clinit_116() , this.caption.element_0), text);
}
...
function add_8(w){
  this.panelbox?this.panelbox.add_1(w, ($clinit_287() , NORTH)):$add_8(this.panel, w, ($clinit_287() , NORTH));
}
...
function setText_3(t){
  $setInnerText_0(($clinit_116() , this.caption.element_0), t);
}
...
function $setProgress_0(this$static, percentage, done, total){
  ...
  if (percentage > 0) {
    if (this$static.showRemaining) {
      ...
      $setInnerText_0(($clinit_116() , this$static.remainLabel.element_0), internationalize_1(remainText, '' + toString_9(remaining)));
    }
  }
   else {
  ...
  if (this$static.showNumbers) {
    ...
    $setInnerText_0(($clinit_116() , this$static.numberLabel.element_0), internationalize_0(message, os));
  }
}
...
function $addClickHandler_3(this$static, handler){
  $addDomHandler(this$static, this$static.mouseOverHandler, ($clinit_191() , $clinit_191() , TYPE_10));
  $addDomHandler(this$static, this$static.mouseOutHandler, ($clinit_189() , $clinit_189() , TYPE_9));
...
function $GWTCColorPicker$ColorCell_0(this$static, color){
  ...
  $addDomHandler(this$static, $GWTCColorPicker$ColorCell$1(new GWTCColorPicker$ColorCell$1, this$static), ($clinit_191() , $clinit_191() , TYPE_10));
  $addDomHandler(this$static, $GWTCColorPicker$ColorCell$2(new GWTCColorPicker$ColorCell$2, this$static), ($clinit_189() , $clinit_189() , TYPE_9));
  return this$static;
}
...
function $VerticalPanel(this$static){
  ...
  this$static.horzAlign = ($clinit_304() , ALIGN_DEFAULT);
...
function $getFontSize(this$static){
  switch (valueOf(__parseAndValidateInt(this$static.font, 10, -2147483648, 2147483647)).value_0) {
    case 1:
      return $clinit_339() , XX_SMALL;
    case 2:
      return $clinit_339() , X_SMALL;
    case 4:
      return $clinit_339() , MEDIUM;
    case 5:
      return $clinit_339() , LARGE;
    case 6:
      return $clinit_339() , X_LARGE;
    case 7:
      return $clinit_339() , XX_LARGE;
    case 3:
    default:return $clinit_339() , SMALL;
  }
}
...
function $GWTCFontPicker$FontCell(this$static, font){
  ...
  $addDomHandler(this$static, $GWTCFontPicker$FontCell$1(new GWTCFontPicker$FontCell$1, this$static), ($clinit_191() , $clinit_191() , TYPE_10));
  $addDomHandler(this$static, $GWTCFontPicker$FontCell$2(new GWTCFontPicker$FontCell$2, this$static), ($clinit_189() , $clinit_189() , TYPE_9));
  return this$static;
}
...
function $Toolbar_0(this$static, richText){
  ...
  $addDomHandler(richText, this$static.handler, ($clinit_178() , $clinit_178() , TYPE_4));
  $addDomHandler(richText, this$static.handler, ($clinit_182() , $clinit_182() , TYPE_6));
...
function onClick_8(event_0){
  ...
  if (sender == this.this$0.bold) {
    ...
    $setJustification(this.this$0.basic, ($clinit_341() , LEFT));
  }
   else if (sender == this.this$0.justifyCenter) {
    $setJustification(this.this$0.basic, ($clinit_341() , CENTER_1));
  }
   else if (sender == this.this$0.justifyRight) {
    $setJustification(this.this$0.basic, ($clinit_341() , RIGHT));
  }
...
function $getAbsoluteLeftImpl(viewport, elem){
  ...
  while (parent_0) {
    parent_0.scrollLeft > 0 && (left -= parent_0.scrollLeft);
...
function $getAbsoluteTopImpl(viewport, elem){
  ...
  var parent_0 = elem.parentNode;
  while (parent_0) {
    parent_0.scrollTop > 0 && (top_0 -= parent_0.scrollTop);
    parent_0 = parent_0.parentNode;
  }
  return top_0 + viewport.scrollTop;
}
...
function $clinit_148(){
  ...
  TYPE_1 = $DomEvent$Type(new DomEvent$Type, 'blur', ($clinit_148() , new BlurEvent));
}
...
function $clinit_150(){
  ...
  TYPE_2 = $DomEvent$Type(new DomEvent$Type, 'change', ($clinit_150() , new ChangeEvent));
}
...
function $clinit_155(){
  ...
  TYPE_3 = $DomEvent$Type(new DomEvent$Type, 'focus', ($clinit_155() , new FocusEvent));
}
...
function $clinit_178(){
  ...
  TYPE_4 = $DomEvent$Type(new DomEvent$Type, 'keydown', ($clinit_178() , new KeyDownEvent));
}
...
function $clinit_180(){
  ...
  TYPE_5 = $DomEvent$Type(new DomEvent$Type, 'keypress', ($clinit_180() , new KeyPressEvent));
}
...
function $clinit_182(){
  ...
  TYPE_6 = $DomEvent$Type(new DomEvent$Type, 'keyup', ($clinit_182() , new KeyUpEvent));
}
...
function $clinit_185(){
  ...
  TYPE_7 = $DomEvent$Type(new DomEvent$Type, 'mousedown', ($clinit_185() , new MouseDownEvent));
}
...
function $clinit_187(){
  ...
  TYPE_8 = $DomEvent$Type(new DomEvent$Type, 'mousemove', ($clinit_187() , new MouseMoveEvent));
}
...
function $clinit_189(){
  ...
  TYPE_9 = $DomEvent$Type(new DomEvent$Type, 'mouseout', ($clinit_189() , new MouseOutEvent));
}
...
function $clinit_191(){
  ...
  TYPE_10 = $DomEvent$Type(new DomEvent$Type, 'mouseover', ($clinit_191() , new MouseOverEvent));
}
...
function $clinit_193(){
  ...
  TYPE_11 = $DomEvent$Type(new DomEvent$Type, 'mouseup', ($clinit_193() , new MouseUpEvent));
}
...
function $DateTimeFormat(this$static, pattern){
  $DateTimeFormat_0(this$static, pattern, $getDateTimeConstants(($clinit_222() , $clinit_222() , instance_0)));
  return this$static;
}
...
function getLongDateFormat(){
  ...
  if (!cachedLongDateFormat) {
    pattern = $dateFormats($getDateTimeConstants(($clinit_222() , $clinit_222() , instance_0)))[1];
...
function getShortDateFormat(){
  ...
  if (!cachedShortDateFormat) {
    pattern = $dateFormats($getDateTimeConstants(($clinit_222() , $clinit_222() , instance_0)))[3];
...
function $clinit_222(){
  ...
  instance_0 = ($clinit_222() , new LocaleInfo);
}
...
function $ampms(this$static){
  ...
  if (args == null) {
    writer = initValues(_3Ljava_lang_String_2_classLit, 233, 1, ['AM', 'PM']);
...
function $dateFormats(this$static){
  ...
  if (args == null) {
    writer = initValues(_3Ljava_lang_String_2_classLit, 233, 1, ['EEEE d MMMM yyyy', 'd MMMM yyyy', 'd MMM yyyy', 'dd/MM/yy']);
...
function $eraNames(this$static){
  ...
  if (args == null) {
    writer = initValues(_3Ljava_lang_String_2_classLit, 233, 1, ['avant J\xE9sus-Christ', 'apr\xE8s J\xE9sus-Christ']);
...
function $eras(this$static){
  ...
  if (args == null) {
    writer = initValues(_3Ljava_lang_String_2_classLit, 233, 1, ['av. J.-C.', 'ap. J.-C.']);
...
function $months(this$static){
  ...
  if (args == null) {
    writer = initValues(_3Ljava_lang_String_2_classLit, 233, 1, ['janvier', 'f\xE9vrier', 'mars', 'avril', 'mai', 'juin', 'juillet', 'ao\xFBt', 'septembre', 'octobre', 'novembre', 'd\xE9cembre']);
...
function $narrowMonths(this$static){
  ...
  if (args == null) {
    writer = initValues(_3Ljava_lang_String_2_classLit, 233, 1, ['J', 'F', 'M', 'A', 'M', 'J', 'J', 'A', 'S', 'O', 'N', 'D']);
...
function $quarters(this$static){
  ...
  if (args == null) {
    writer = initValues(_3Ljava_lang_String_2_classLit, 233, 1, ['1er trimestre', '2e trimestre', '3e trimestre', '4e trimestre']);
...
function $shortMonths(this$static){
  ...
  if (args == null) {
    writer = initValues(_3Ljava_lang_String_2_classLit, 233, 1, ['janv.', 'f\xE9vr.', 'mars', 'avr.', 'mai', 'juin', 'juil.', 'ao\xFBt', 'sept.', 'oct.', 'nov.', 'd\xE9c.']);
...
function $shortWeekdays(this$static){
  ...
  if (args == null) {
    writer = initValues(_3Ljava_lang_String_2_classLit, 233, 1, ['dim.', 'lun.', 'mar.', 'mer.', 'jeu.', 'ven.', 'sam.']);
...
function $standaloneWeekdays(this$static){
  ...
  if (args == null) {
    writer = initValues(_3Ljava_lang_String_2_classLit, 233, 1, ['dimanche', 'lundi', 'mardi', 'mercredi', 'jeudi', 'vendredi', 'samedi']);
...
function div_0(a, b){
  ...
  if (a[0] == 0 && a[1] == 0) {
    return $clinit_239() , ZERO;
  }
  if (eq(a, ($clinit_239() , MIN_VALUE))) {
...
function fromDouble(value){
  ...
  if (value < -9223372036854775808) {
    return $clinit_239() , MIN_VALUE;
  }
  if (value >= 9223372036854775807) {
    return $clinit_239() , MAX_VALUE;
  }
  if (value > 0) {
...
function fromInt(value){
  ...
  if (value > -129 && value < 128) {
    rebase = value + 128;
    result = ($clinit_238() , boxedValues)[rebase];
...
function shru(a, n){
  ...
  n &= 63;
  sr = shr(a, n);
  a[1] < 0 && (sr = add_10(sr, shl(($clinit_239() , TWO), 63 - n)));
  return sr;
}
...
function toDoubleRoundDown(a){
  ...
  magnitute = round_int(Math.log(a[1]) / ($clinit_239() , LN_2));
  if (magnitute <= 48) {
    return a[1] + a[0];
  }
   else {
...
function onClosing(){
  var event_0;
  if (closeHandlersInitialized) {
    event_0 = ($clinit_262() , new Window$ClosingEvent);
...
function $DockPanel$LayoutData(this$static, dir){
  this$static.hAlign = ($clinit_304() , ALIGN_DEFAULT).textAlignString;
  this$static.vAlign = ($clinit_308() , ALIGN_TOP).verticalAlignString;
...
function $setText_7(this$static, row, column, text){
  ...
  text != null && $setInnerText_0(($clinit_116() , td), text);
}
...
function $clinit_304(){
  ...
  ALIGN_DEFAULT = ($clinit_222() , ALIGN_LEFT);
}
...
function $openPopup(this$static, item){
  ...
  this$static.popup.animType = ($clinit_331() , ONE_WAY_CORNER);
...
function $onResize(){
  ...
  null.nullMethod(0 + ($clinit_138() , 'px'));
  null.nullMethod('0px');
...
function $onComplete(this$static){
  if (!this$static.showing) {
    ...
    $remove_1(($clinit_342() , get_0(null)), this$static.curPanel);
    $clinit_4();
  }
...
function $onInstantaneousRun(this$static){
  ...
  if (this$static.showing) {
    ...
    $add_6(($clinit_342() , get_0(null)), this$static.curPanel);
    $clinit_4();
  }
   else {
    $remove_1(($clinit_342() , get_0(null)), this$static.curPanel);
...
function $setState_0(this$static, showing){
  ...
  this$static.curPanel.animType != ($clinit_331() , CENTER_0) && !showing && (animate = false);
  this$static.showing = showing;
  if (animate) {
    if (showing) {
      $maybeShowGlass(this$static);
...
function $menuBarSubMenuIcon(){
  !menuBarSubMenuIcon && (menuBarSubMenuIcon = $ImageResourcePrototype(new ImageResourcePrototype, ($clinit_222() , 'data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAUAAAAJCAYAAAD6reaeAAAAI0lEQVR42mNgYGD4z4AF/Mcm8R+bxH9sEv+xSRBUSdh2FAAAXN8Y6EbBLKwAAAAASUVORK5CYII='), 0, 0, 5, 9));
...
function $clinit_362(){
  ...
  implPanel?($clinit_362() , new FocusImpl):implPanel;
}
...
function $setClip(popup, rect){
  ...
  popup.style['display'] = ($clinit_127() , 'none');
  popup.style['display'] = '';
}
...
function execute_9(){
  this.val$outerElem.style['overflow'] = ($clinit_133() , 'auto');
}
...
function $setJustification(this$static, justification){
  justification == ($clinit_341() , CENTER_1)?$execCommand(this$static, 'JustifyCenter', null):justification == FULL?$execCommand(this$static, 'JustifyFull', null):justification == LEFT?$execCommand(this$static, 'JustifyLeft', null):justification == RIGHT && $execCommand(this$static, 'JustifyRight', null);
}

function $setText_10(this$static, text){
  !this$static.beforeInitPlaceholder?(this$static.elem.contentWindow.document.body.textContent = text , undefined):($setInnerText_0(($clinit_116() , this$static.beforeInitPlaceholder), text) , undefined);
}
...
function valueOf(i){
  ...
  if (i > -129 && i < 128) {
    rebase = i + 128;
    result = ($clinit_386() , boxedValues_0)[rebase];
...
function $Box(this$static, prop_0){
  ...
  $add_16(this$static, getImpl(this$static.jsProp.p_0, 'html', ''), ($clinit_438() , NORTH_0));
...
function add_21(object){
  $add_16(this, object, ($clinit_438() , NORTH_0));
}
...
function $export0_3(){
  ...
  $wnd.jsc.Const = function(){
    if (arguments.length == 1 && arguments[0] != null && getTypeName(arguments[0]) == 'jschismes.client.Const') {
      ...
      this.instance = ($clinit_438() , new Const);
      $clinit_469();
      this.instance['__gwtex_wrap'] = this;
    }
  }
  ...
  $wnd.jsc.Const.SHORT_FORMAT = ($clinit_438() , SHORT_FORMAT);
...
function $Popup(this$static, prop_0){
  ...
  (this$static.jsProp.p_0['className']?true:false) && $setStyleName(this$static, getImpl(this$static.jsProp.p_0, 'className', ''));
  (this$static.jsProp.p_0['text']?true:false) && $add_1(this$static, getImpl(this$static.jsProp.p_0, 'text', ''), ($clinit_438() , NORTH_0));
  return this$static;
}

function add_23(object){
  $add_1(this, object, ($clinit_438() , NORTH_0));
}
...
function setText_10(text){
  $setInnerText_0(($clinit_116() , this.textLabel.element_0), text);
}
