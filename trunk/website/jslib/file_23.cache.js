...
function $center_0(this$static){
  ...
  $setPopupPosition(this$static, $getScrollLeft_2(($clinit_57() , $doc).body) + left, ($doc.body.scrollTop || 0) + top_0);
  if (!initiallyShowing) {
...
function $moveIntoVisibleArea(this$static){
  var h, hd, w, wd, xd, yd;
  if (this$static.calendarDlg) {
    w = $getClientWidth($doc) + $getScrollLeft_2(($clinit_57() , $doc).body);
...
function $setMaxdays(this$static, d){
  ...
  ($clinit_57() , this$static.nightsListBox.element_0).innerText = '';
...
function $setNights(this$static, n){
  if (!!this$static.nightsListBox && ($clinit_57() , this$static.nightsListBox.element_0).children.length >= n)
...
function $updateTextElementsFromCheckin(this$static){
  ...
  if (nights >= 0 && nights < ($clinit_57() , this$static.nightsListBox.element_0).children.length)
...
function $getScrollLeft_2(this$static){
  return $getScrollLeft(($clinit_57() , this$static));
}
...
function $getX(this$static){
  ...
  if (relativeElem) {
    return e = this$static.nativeEvent , (($clinit_57() , e).clientX || 0) - $getAbsoluteLeft(relativeElem) + $getScrollLeft(relativeElem) + $getScrollLeft(relativeElem.ownerDocument.body);
  }
...
function $getY(this$static){
  ...
  relativeElem = this$static.relativeElem;
  if (relativeElem) {
    return e = this$static.nativeEvent , (($clinit_57() , e).clientY || 0) - $getAbsoluteTop(relativeElem) + (relativeElem.scrollTop || 0) + (relativeElem.ownerDocument.body.scrollTop || 0);
  }
...
function $checkIndex(this$static, index){
  if (index < 0 || index >= ($clinit_57() , this$static.element_0).children.length) {
...
function $setItemSelected(this$static, index, selected){
  ...
  ($clinit_57() , this$static.element_0).children[index].selected = selected;
}
...
function $init_1(this$static, vertical){
  ...
  outer = $createFocusable(($clinit_200() , impl_0));
...
function $itemOver(this$static, item, focus_0){
  ...
  $selectItem(this$static, item);
  if (focus_0) {
    $focus_0(($clinit_200() , impl_0 , this$static.element_0));
  }
  if (item) {
...
function $moveDown(this$static){
  ...
  if (this$static.vertical) {
    ...
    if (!!this$static.selectedItem.subMenu && this$static.selectedItem.subMenu.items.size != 0 && (!this$static.shownChildMenu || !this$static.shownChildMenu.selectedItem)) {
      ...
      $focus_0(($clinit_200() , this$static.selectedItem.subMenu.element_0));
    }
...
function onBrowserEvent_3(event_0){
  ...
  switch ($eventGetTypeInt(event_0.type)) {
    case 1:
      {
        $focus_0(($clinit_200() , impl_0 , this.element_0));
        if (item) {
...
function $setSubMenu(this$static, subMenu){
  ...
  ($clinit_200() , subMenu.element_0).firstChild.tabIndex = -1;
...
function $clinit_271(){
  ...
  implWidget = implPanel?($clinit_271() , new FocusImpl()):implPanel;
}
...
function $handleAsClick(event_0){
  ...
  mouseButtons = $eventGetButton(($clinit_57() , event_0));
  alt = !!event_0.altKey;
