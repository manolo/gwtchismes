function jschismes_JsChismesPretty(){
  ...
  var strongName;
  try {
    unflattenKeylistIntoAnswers(['default', 'ie6'], 'file_46.cache.js');
    unflattenKeylistIntoAnswers(['en', 'ie6'], 'file_12.cache.js');
    unflattenKeylistIntoAnswers(['es', 'ie6'], 'file_30.cache.js');
    unflattenKeylistIntoAnswers(['fr', 'ie6'], 'file_11.cache.js');
    unflattenKeylistIntoAnswers(['ja', 'ie6'], 'file_43.cache.js');
    unflattenKeylistIntoAnswers(['default', 'opera'], 'file_1.cache.js');
    unflattenKeylistIntoAnswers(['en', 'opera'], 'file_8.cache.js');
    unflattenKeylistIntoAnswers(['es', 'opera'], 'file_35.cache.js');
    unflattenKeylistIntoAnswers(['fr', 'opera'], 'file_26.cache.js');
    unflattenKeylistIntoAnswers(['ja', 'opera'], 'file_27.cache.js');
    unflattenKeylistIntoAnswers(['default', 'gecko1_8'], 'file_38.cache.js');
    unflattenKeylistIntoAnswers(['en', 'gecko1_8'], 'file_36.cache.js');
    unflattenKeylistIntoAnswers(['es', 'gecko1_8'], 'file_49.cache.js');
    unflattenKeylistIntoAnswers(['fr', 'gecko1_8'], 'file_3.cache.js');
    unflattenKeylistIntoAnswers(['ja', 'gecko1_8'], 'file_5.cache.js');
    unflattenKeylistIntoAnswers(['default', 'safari'], 'file_10.cache.js');
    unflattenKeylistIntoAnswers(['en', 'safari'], 'file_32.cache.js');
    unflattenKeylistIntoAnswers(['es', 'safari'], 'file_20.cache.js');
    unflattenKeylistIntoAnswers(['fr', 'safari'], 'file_15.cache.js');
    unflattenKeylistIntoAnswers(['ja', 'safari'], 'file_13.cache.js');
    unflattenKeylistIntoAnswers(['default', 'gecko'], 'file_9.cache.js');
    unflattenKeylistIntoAnswers(['en', 'gecko'], 'file_14.cache.js');
    unflattenKeylistIntoAnswers(['es', 'gecko'], 'file_19.cache.js');
    unflattenKeylistIntoAnswers(['fr', 'gecko'], 'file_41.cache.js');
    unflattenKeylistIntoAnswers(['ja', 'gecko'], 'file_48.cache.js');
