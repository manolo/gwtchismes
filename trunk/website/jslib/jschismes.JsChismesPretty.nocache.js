function jschismes_JsChismesPretty(){
  ...
  var strongName;
  try {
    unflattenKeylistIntoAnswers(['default', 'ie6'], 'file_45.cache.js');
    unflattenKeylistIntoAnswers(['en', 'ie6'], 'file_6.cache.js');
    unflattenKeylistIntoAnswers(['es', 'ie6'], 'file_5.cache.js');
    unflattenKeylistIntoAnswers(['fr', 'ie6'], 'file_13.cache.js');
    unflattenKeylistIntoAnswers(['ja', 'ie6'], 'file_48.cache.js');
    unflattenKeylistIntoAnswers(['default', 'opera'], 'file_12.cache.js');
    unflattenKeylistIntoAnswers(['en', 'opera'], 'file_24.cache.js');
    unflattenKeylistIntoAnswers(['es', 'opera'], 'file_27.cache.js');
    unflattenKeylistIntoAnswers(['fr', 'opera'], 'file_17.cache.js');
    unflattenKeylistIntoAnswers(['ja', 'opera'], 'file_42.cache.js');
    unflattenKeylistIntoAnswers(['default', 'gecko1_8'], 'file_18.cache.js');
    unflattenKeylistIntoAnswers(['en', 'gecko1_8'], 'file_25.cache.js');
    unflattenKeylistIntoAnswers(['es', 'gecko1_8'], 'file_28.cache.js');
    unflattenKeylistIntoAnswers(['fr', 'gecko1_8'], 'file_11.cache.js');
    unflattenKeylistIntoAnswers(['ja', 'gecko1_8'], 'file_8.cache.js');
    unflattenKeylistIntoAnswers(['default', 'safari'], 'file_32.cache.js');
    unflattenKeylistIntoAnswers(['en', 'safari'], 'file_44.cache.js');
    unflattenKeylistIntoAnswers(['es', 'safari'], 'file_16.cache.js');
    unflattenKeylistIntoAnswers(['fr', 'safari'], 'file_10.cache.js');
    unflattenKeylistIntoAnswers(['ja', 'safari'], 'file_26.cache.js');
    unflattenKeylistIntoAnswers(['default', 'gecko'], 'file_2.cache.js');
    unflattenKeylistIntoAnswers(['en', 'gecko'], 'file_50.cache.js');
    unflattenKeylistIntoAnswers(['es', 'gecko'], 'file_7.cache.js');
    unflattenKeylistIntoAnswers(['fr', 'gecko'], 'file_1.cache.js');
    unflattenKeylistIntoAnswers(['ja', 'gecko'], 'file_34.cache.js');
