...
function maximizeWidget(widget){
  ...
  if (!widget)
    return;
  w = max_0($doc.documentElement.clientWidth || $doc.body.clientWidth, max_0($doc.compatMode == 'CSS1Compat'?$doc.documentElement.scrollWidth:$doc.body.scrollWidth, parseInt(($clinit_254() , get_0(null)).element_0['offsetWidth']) || 0));
